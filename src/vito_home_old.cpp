...
void DesperateDecisionMaker::SendHomeRobot_left()
{
  ...
  // {
    ...
    home_robot_left.pose.orientation.x = (quat_eigen_hand.normalized()).x();
    home_robot_left.pose.orientation.y = (quat_eigen_hand.normalized()).y();
    home_robot_left.pose.orientation.z = (quat_eigen_hand.normalized()).z();
    home_robot_left.pose.orientation.w = (quat_eigen_hand.normalized()).w();
...
void DesperateDecisionMaker::SendHomeRobot_right()
{
    ...
    home_robot_right.pose.orientation.x = (quat_eigen_hand_right.normalized()).x();
    home_robot_right.pose.orientation.y = (quat_eigen_hand_right.normalized()).y();
    home_robot_right.pose.orientation.z = (quat_eigen_hand_right.normalized()).z();
    home_robot_right.pose.orientation.w = (quat_eigen_hand_right.normalized()).w();
