...
Eigen::Matrix4d ROT_y;
  ...
  // home_robot_right.pose.orientation.x = home_robot_left.pose.orientation.x; 
  // home_robot_right.pose.orientation.y = home_robot_left.pose.orientation.y;
  // home_robot_right.pose.orientation.z = home_robot_left.pose.orientation.z;
  // home_robot_right.pose.orientation.w = home_robot_left.pose.orientation.w;
