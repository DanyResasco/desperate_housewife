...
Eigen::Matrix<double, 7, 1>  PotentialFieldControlKinematic::getTauRepulsive(Eigen::Matrix<double, 6, 6> lambda, KDL::Jacobian &J, unsigned int n_joint, Eigen::Matrix<double, 6, 1> F)
{
